  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'primary-light-75': '#dae2eb',
        'primary-light-60': '#c4d0df',
        'primary-light-45': '#aebfd2',
        'primary-light-30': '#97adc6',
        'primary-light-15': '#819cba',
        'primary-main': '#6b8aae',
        'primary-dark-15': '#5b7594',
        'primary-dark-30': '#4b617a',
        'primary-dark-45': '#3b4c60',
        'primary-dark-60': '#2b3746',
        'primary-dark-75': '#1b232c',

        'secondary-light-75': '#daebe2',
        'secondary-light-60': '#c4dfd1',
        'secondary-light-45': '#aed2bf',
        'secondary-light-30': '#97c6ae',
        'secondary-light-15': '#81ba9c',
        'secondary-main': '#6bae8b',
        'secondary-dark-15': '#5b9476',
        'secondary-dark-30': '#4b7a61',
        'secondary-dark-45': '#3b604c',
        'secondary-dark-60': '#2b4638',
        'secondary-dark-75': '#1b2c23',
